...
export default function TabBar({ active, action }: { active: Tabs, action: (tab: Tabs) => void}) {
  ...
  return (
    <div className="relative grid grid-cols-2 border-b text-sm font-semibold">
      {TABS.map((tab, key) => (
      ...
      <div aria-hidden className="absolute inset-0 grid grid-cols-2 divide-x pointer-events-none" >
        <div />
        <div />
      </div>
    </div>
